...
#include "goby/acomms/dccl/dccl_bitset.h" // for Bitset
#include "goby/acomms/dccl/dccl_field_codec_typed.h" // for DCCLTypedFieldCodec
...
private:
  ...
  private:
    ...
    std::vector<double> m_tprob;
    std::vector<double> m_cprob;
